package kr.hs.emirim.w2023.ex10_19_20;
        ...
        public void onClick(View v) {
            ...
            switch(v.getId()){
                ...
                case R.id.btn_homepage:
                    ...
                    break;
                case R.id.btn_map:
                    uri = Uri.parse("https://www.google.co.kr/maps?q="+36.984118822610256+","+126.92430299702896);
                    intent = new Intent(Intent.ACTION_VIEW,uri );
                    break;
                ...
                case R.id.btn_sms:
                    ...
                    intent.putExtra("sms_body","우리팀 어떻게 하면 좋을까?");
                    intent.setData(uri);
                    break;
                case R.id.btn_photo:
